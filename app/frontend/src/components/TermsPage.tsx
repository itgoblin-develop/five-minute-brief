...
export function TermsPage({ type, onBack }: TermsPageProps) {
  ...
  const content = type === 'service' 
    ? `제1조 (목적)
본 약관은 IT 도깨비(이하 "회사")이 제공하는 뉴스 요약 서비스(이하 "서비스")의 이용과 관련하여 회사와 회원 간의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.

제2조 (용어의 정의)
1. "서비스"라 함은 구현되는 단말기와 상관없이 회원이 이용할 수 있는 IT 도깨비 관련 제반 서비스를 의미합니다.
